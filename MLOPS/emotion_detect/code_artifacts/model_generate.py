...
def Model_generate(
    ...
    checkpointer = tf.keras.callbacks.ModelCheckpoint(
        "/home/abhinav/Personal_project/FullStackProject-with-ML/MLOPS/emotion_detect/models",
        monitor="val_loss",
        verbose=1,
        save_best_only=True,
    )
    ...
    model.save(
        f"/home/abhinav/Personal_project/FullStackProject-with-ML/MLOPS/emotion_detect/models/model_{version}.h5"
    )
