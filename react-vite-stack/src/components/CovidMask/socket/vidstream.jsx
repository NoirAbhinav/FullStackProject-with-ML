...
function MyWebcam({ socket, intervalRef }) {
...
function CovidMaskSocket() {
  const socket = React.useRef(new WebSocket("ws://localhost:8000/covmaskws"));
...
export default CovidMaskSocket;
